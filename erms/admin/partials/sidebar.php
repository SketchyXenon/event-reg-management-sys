...
<aside class="sidebar" id="sidebar">
  <!-- Brand area: fully self-contained, no CSS class conflicts -->
  <div style="flex-shrink:0;padding:16px 14px 14px;border-bottom:1px solid rgba(255,255,255,0.07);background:inherit;">
    <!-- Row: crest + title -->
    <div style="display:flex;align-items:center;gap:10px;min-width:0;">
      <div style="width:34px;height:34px;flex-shrink:0;background:linear-gradient(135deg,#4a7ab5,#c9a84c);border-radius:7px;display:flex;align-items:center;justify-content:center;font-size:.95rem;font-weight:700;color:#080b10;box-shadow:0 0 14px rgba(74,122,181,.4);">CTU</div>
      <div style="min-width:0;overflow:hidden;">
        <div style="font-size:.9rem;font-weight:600;color:var(--t1,#e6e3db);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;line-height:1.2;">ERMS ADMIN</div>
        <div style="font-size:.6rem;color:var(--t3,#505870);letter-spacing:.1em;text-transform:uppercase;margin-top:2px;">Control Panel</div>
      </div>
    </div>
    <!-- Clock below -->
    <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,0.07);">
      <div class="sb-clock__time" id="sbTime" style="font-size:1.1rem;font-weight:500;color:var(--t1,#e6e3db);letter-spacing:.06em;font-family:var(--fm,'JetBrains Mono',monospace);">--:--:--</div>
      <div class="sb-clock__date" id="sbDate" style="font-size:.58rem;color:var(--t3,#505870);letter-spacing:.04em;text-transform:uppercase;margin-top:4px;">--- --, ----</div>
    </div>
  </div>
