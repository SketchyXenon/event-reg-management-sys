    ...
    <aside class="auth-brand">
      <div class="brand-top">
        ...
        <ul class="brand-perks">
          <li>
            <div class="perk-dot"></div> Instant access to all campus events
          </li>
          <li>
            <div class="perk-dot"></div> Track your registrations in one place
          </li>
          <li>
            <div class="perk-dot"></div> Get notified of new opportunities
          </li>
          <li>
            <div class="perk-dot"></div> Manage your academic schedule
          </li>
        </ul>
      </div>
