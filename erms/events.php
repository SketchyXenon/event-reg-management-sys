...
<body class="has-sidebar">
  ...
  <aside class="sidebar" id="sidebar">
    <div style="display:flex;flex-direction:column;flex-shrink:0;padding:16px 14px 14px;border-bottom:1px solid rgba(255,255,255,0.07);background:inherit;">
      <div style="display:flex;align-items:center;justify-content:center;gap:10px;min-width:0;">
        ...
        <div style="min-width:0;overflow:hidden;">
          <div style="font-size:.9rem;font-weight:600;color:var(--text,#e6e3db);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;line-height:1.2;">ERMS</div>
          <div style="font-size:.6rem;color:var(--text-3,#505870);letter-spacing:.1em;text-transform:uppercase;margin-top:2px;">Student Portal</div>
        </div>
      </div>
      <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,0.07);text-align:center;">
        <div id="sbTime" style="font-family:var(--ff-m,'JetBrains Mono',monospace);font-size:1.1rem;font-weight:500;color:var(--text,#e6e3db);letter-spacing:.06em;">--:--:--</div>
        <div id="sbDate" style="font-size:.58rem;color:var(--text-3,#505870);letter-spacing:.04em;text-transform:uppercase;margin-top:4px;">--- --, ----</div>
      </div>
    </div>
    </div>
