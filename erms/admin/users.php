...
<head>
    ...
    <style>
        ...
        .u-role--student {
            ...
            color: #6a96cc;
            border-color: rgba(74, 122, 181, .25);
        }

        .u-role--admin {
            background: rgba(201, 120, 76, .12);
            color: #d4956a;
            border-color: rgba(201, 120, 76, .25);
        }
    ...
    <div class="topbar">
        ...
        <div style="position:relative;display:inline-block;margin-right:8px;" id="exportDropWrap">
            ...
            <div id="exportDrop" style="display:none;position:absolute;top:calc(100% + 6px);right:0;min-width:220px;background:var(--bg2,#141824);border:1px solid var(--bdr);border-radius:10px;box-shadow:0 8px 28px rgba(0,0,0,.35);z-index:999;overflow:hidden;">
                ...
                <div style="padding:8px 6px;">
                    ...
                    <button onclick="doExport('users','csv')" class="exp-item"><span>&#128196;</span> CSV <span style="font-size:.7rem;color:var(--t3);">(.csv)</span></button>
                    <button onclick="doExport('users','excel')" class="exp-item"><span>&#128202;</span> Excel <span style="font-size:.7rem;color:var(--t3);">(.xls)</span></button>
                    <button onclick="doExport('users','pdf')" class="exp-item"><span>&#128424;</span> PDF <span style="font-size:.7rem;color:var(--t3);">(print / save)</span></button>
                </div>
            </div>
        </div>
        <style>
        ...
        <script>
            ...
            function doExport(type, format) {
                ...
                var base = "q=" + encodeURIComponent(document.querySelector('[name=q]')?.value || '') + "&role=" + encodeURIComponent(document.querySelector('[name=role]')?.value || 'all');
        ...
        <div class="page-content">
            ...
            <div class="c-stats" style="grid-template-columns:repeat(4,1fr)">
                <div class="c-stat c-stat--blue">
                    ...
                    <div class="c-stat__icon"><svg width="56" height="56" fill="currentColor" viewBox="0 0 24 24">
