...
<nav class="nav" id="navbar">
  <a href="index.php" class="nav-brand">
    ...
    <div>
      <div class="nav-name">Event Registration &amp; Management <span>System</span></div>
      <div class="nav-tagline">Cebu Technological University — ERMS</div>
    </div>
  </a>
...
<footer>
  <div class="footer-brand">
    ...
    <div>
      <div style="font-family:var(--ff-d);font-size:.95rem;font-weight:600;color:var(--text)">Event Registration &amp; Management System</div>
      <div style="font-size:.75rem;color:var(--text-3);margin-top:2px">Cebu Technological University — ERMS</div>
    </div>
  </div>
